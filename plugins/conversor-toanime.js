...
const handler = async (m, {args,command,usedPrefix,__dirname,conn,text,isAdmin,isOwner}) => {
  ...
  const styleMappings = {
    "horrible.zombie": "horrible_zombie",
      "halloween.makeup": "halloween_makeup",
      "dark.gothic": "dark_gothic",
      "halloween.dark.makeup": "halloween_dark_makeup",
      "japanese.horror": "japanese_horror",
      "synthwave.punk": "synthwave_punk",
      "chocolate.man": "chocolate_man",
      "crazy.scientist": "crazy_scientist",
      "dont.starve": "dont_starve",
      "white.statue": "white_statue",
      "colorful.illustration": "colorful_illustration",
      "papercut.craft": "papercut_craft",
      "blood.of.blue": "blood_of_blue",
      "cyber.punk": "cyber_punk",
      "fanatic.adventure": "fanatic_adventure",
      "legend.of.elf": "legend_of_elf",
      "racer": "racer",
      "cute.cartoon": "cute_cartoon",
      "super.hero": "super_hero",
      "pixel.art": "pixel_art",
      "retro.style": "retro_style",
      "black.swing": "black_swing",
      "fairy.tale": "fairy_tale",
      "thick.impasto": "thick_impasto",
      "rainbow.hair": "rainbow_hair",
      "30s.style": "30s_style",
      "water.magic": "water_magic",
      "on.fire": "on_fire",
      "luminous.cloud": "luminous_cloud",
      "pocket.pet": "pocket_pet",
      "spirited.wind": "spirited_wind",
      "3d.style": "3d_style",
      "red.redemption": "red_redemption",
      "boxing.man": "boxing_man",
      "hell.kight": "hell_kight",
      "calendar.girl": "calendar_girl",
      "cute.illustration": "cute_illustration",
      "aging.filter": "aging_filter",
      "realistic.fire": "realistic_fire",
      "tattoo.magic": "tattoo_magic",
      "christmas.girl": "christmas_girl",
      "ps.game.style.1": "ps_game_style_1",
      "thunderstruck.armor": "thunderstruck_armor",
      "lightning.punk": "lightning_punk",
      "aether.punk": "aether_punk",
      "new.worlds.pirates": "new_worlds_pirates",
      "legend.fighters": "legend_fighters",
      "barbie.girl": "barbie_girl",
      "cool.guy": "cool_guy",
      "muscle.man": "muscle_man",
      "blindbox": "blindbox",
      "melted.chocolate": "melted_chocolate",
      "block.world": "block_world",
      "90s.comic": "90s_comic",
      "realistic.thunderstruck$armor": "realistic_thunderstruck_armor",
      "anime.2d": "anime_2d",
      "realistic$lightning$punk": "realistic_lightning_punk",
      "white.skin": "white_skin",
      "hourglass.body.shape": "hourglass_body_shape",
      "pixel.style": "pixel_style",
      "anime.hero": "anime_hero",
      "christmas.3d": "christmas_3d",
      "christmas.family": "christmas_family",
      "cartoon": "cartoon",
      "80s.style": "80s_style",
      "christmas.cartoon": "christmas.cartoon",
      "ps.game.style.2": "ps_game_style_2",
      "anime": "anime",
      "city.punk": "city_punk",
      "cartoon.tattoo.muscle": "cartoon_tattoo_muscle",
      "pocket.pet": "pocket_pet",
      "christmas.comic": "christmas_comic",
      "magic.muscle": "magic_muscle",
      "super.bowl": "super_bowl",
      "romantic.anime": "romantic_anime",
      "animal.ears": "animal_ears",
      "brick.world": "brick_world",
      "skeleton.bride": "skeleton_bride",
      "joker": "joker",
    "zombie": "zombie",
    "palhaco": "palhaco",
    "coelho":"coelho",
...
const helpText = idioma == 'en' ? 
`⚠ ɪɴᴠᴀʟɪᴅ ᴄᴏᴍᴍᴀɴᴅ, ᴋɪᴅ!
> ᴛᴏ ᴜꜱᴇ ᴍʏ ᴘʜᴏᴛᴏ ᴍᴀɢɪᴄ, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ᴛᴇʟʟ ᴍᴇ ᴡʜᴀᴛ ᴇꜰꜰᴇᴄᴛ ʏᴏᴜ ᴡᴀɴᴛ. 
> ᴜꜱᴇ ᴛʜᴇ ᴇxᴀᴍᴘʟᴇ: .ᴇꜰꜰᴇᴄᴛ [ᴇꜰꜰᴇᴄᴛ]` 
:
`⚠ ᴄᴏᴍᴀɴᴅᴏ ɪɴᴠᴀʟɪᴅᴏ, ɢᴀʀᴏᴛᴏ! 
> ᴘᴀʀᴀ ᴜꜱᴀʀ ᴍɪɴʜᴀ ᴍᴀɢɪᴄᴀ ᴄᴏᴍ ꜰᴏᴛᴏꜱ, ᴠᴏᴄᴇ ᴘʀᴇᴄɪꜱᴀ ᴍᴇ ɪɴꜰᴏʀᴍᴀʀ Qᴜᴀʟ ᴏ ᴇꜰᴇɪᴛᴏ Qᴜᴇ Qᴜᴇʀ. 
> ᴜꜱᴇ ᴏ ᴇxᴇᴍᴘʟᴏ .ᴇꜰᴇɪᴛᴏ [ᴇꜰᴇɪᴛᴏ]`

const helpMenu = `┌──[ BYΓΞSΞC ]─[~] 
└─ $ ./effects.py
> ‎ 
${helpText}
