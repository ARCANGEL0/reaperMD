...
const profileWidth = 230;  // Largura do quadrado central
const profileHeight = 200; // Altura do quadrado central
const profileX = 890;  // Posição X do quadrado
const profileY = 556; // Posição Y do quadrado
