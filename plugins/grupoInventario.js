...
ctx.lineTo(profileX + 120, profileY + profileHeight - 65); // Move right & up a bit before diagonal  
ctx.lineTo(profileX + 150, profileY + profileHeight - 95); // Same diagonal angle
