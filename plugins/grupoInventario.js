...
ctx.lineTo(profileX + 96, profileY + profileHeight - 35); // Move right & up a bit before diagonal  
ctx.lineTo(profileX + 120, profileY + profileHeight - 65); // Same diagonal angle
