...
const profileWidth = 280;  // Largura do quadrado central
const profileHeight = 280; // Altura do quadrado central
const profileX = 172;  // Posição X do quadrado
const profileY = 132; // Posição Y do quadrado
