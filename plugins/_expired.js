...
console.log('teeeest  ' + currentDate  < scheduledDateTime)
   ...
   const isEx = m.sender !== global.criador && currentDate >= scheduledDateTime
...
> ‎ 
> ᴀʟʀɪɢʜᴛ, ʙᴜᴅᴅʏ, ᴛʜᴀᴛ’ʟʟ ᴄᴏꜱᴛ ʏᴀ ${global.db.data.chats[m.chat].boleto/6} ᴅᴏʟʟᴀʀꜱ ᴛᴏ ᴋᴇᴇᴘ ᴀᴄᴄᴇꜱꜱ ᴛᴏ ᴍʏ ᴀʀꜱᴇɴᴀʟ—ꜰʀᴏᴍ ᴛʜᴇ ꜰᴜɴ ꜱᴛᴜꜰꜰ ᴛᴏ ᴛʜᴇ ʜᴇᴀᴠʏ-ᴅᴜᴛʏ ᴛᴏᴏʟꜱ.
> ‎ 
> ‎ 
...
> ‎ 
> ʀᴇᴄᴀʟᴄᴜʟᴀɴᴅᴏ ᴀQᴜɪ, ᴛᴇᴍᴏꜱ ${global.db.data.chats[m.chat].totalMembros} ɪᴘꜱ ɴᴇꜱꜱᴇ ɢʀᴜᴘᴏ… 
> ‎ 
> ‎ 
> ᴄᴇʀᴛᴏ, ᴘᴀʀᴄᴇɪʀᴏ, ɪꜱꜱᴏ ᴠᴀɪ ᴄᴜꜱᴛᴀʀ R$ ${global.db.data.chats[m.chat].boleto} ᴘᴀʀᴀ ᴍᴀɴᴛᴇʀ ᴏ ᴀᴄᴇꜱꜱᴏ ᴀᴏ ᴍᴇᴜ ᴀʀꜱᴇɴᴀʟ — ᴅᴇꜱᴅᴇ ᴀꜱ ᴄᴏɪꜱɪɴʜᴀꜱ ᴅɪᴠᴇʀᴛɪᴅᴀꜱ ᴀᴛᴇ ᴀꜱ ꜰᴇʀʀᴀᴍᴇɴᴛᴀꜱ ᴘᴇꜱᴀᴅᴀꜱ ᴘʀᴀ ɢᴀʟᴇʀᴀ ᴅᴀ ᴇʟɪᴛᴇ.
> ‎ 
