...
if (ps.length < number) {
    throw " É 𝚙𝚛𝚎𝚌𝚒𝚜𝚘 𝚖𝚊𝚒𝚜 𝚍𝚎 " + number + " 𝚊𝚕𝚖𝚊𝚜 𝚗𝚎𝚜𝚝𝚎 𝚐𝚛𝚞𝚙𝚘 𝚙𝚊𝚛𝚊 𝚞𝚜𝚊𝚛 𝚎𝚜𝚝𝚎 𝚛𝚎𝚌𝚞𝚛𝚜𝚘. . .";
}
...
┗━── `, // Replace with the desired caption
    ...
    m.reply(`⎔⎓──────────────
┃  ✇  𝑨𝒐 𝒐𝒃𝒔𝒆𝒓𝒗𝒂𝒓 𝒔𝒆𝒖 𝒂𝒍𝒗𝒐... 𝒈𝒂𝒏𝒉𝒐𝒖 𝒖𝒎𝒂 𝑨𝒅𝒂𝒈𝒂
𝒅𝒂𝒔 𝑺𝒐𝒎𝒃𝒓𝒂𝒔 🗡
╰─...⎔⎓──────────`);
...
ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 🜅 ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${user(who)}
...
ɴᴏɪᴛᴇ, ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 🜅 ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${userH(who)}
𒁂
...
𒁂 ${user(m.sender)} ᴜsᴀɴᴅᴏ sᴜᴀs ʜᴀʙɪʟɪᴅᴀᴅᴇs ᴀᴅǫᴜɪʀɪᴅᴀs ᴄᴏᴍᴏ ᴜᴍ ᴇsᴘᴇᴄᴛʀᴏ ᴅᴀ ɴᴏɪᴛᴇ,
ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} 🜅 ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${user(who)} 𒁂
