...
╰─...⎔⎓──────────`, // Replace with the desired caption
  ...
  global.db.data.chats[m.chat].users[m.sender].rings-=1
   m.react("💍")
...
𝑷𝒂𝒓𝒂 𝒔𝒆𝒈𝒖𝒊𝒓 𝒂𝒅𝒊𝒂𝒏𝒕𝒆 𝒄𝒐𝒎 𝒐𝒔 𝒕𝒓𝒂𝒎𝒊𝒕𝒆𝒔 𝒏𝒐 𝒄𝒂𝒓𝒕𝒐𝒓𝒊𝒐 𝒆 𝒅𝒂𝒓 𝒊𝒏𝒊𝒄𝒊𝒐 𝒂𝒐 𝒑𝒓𝒐𝒄𝒆𝒔𝒔𝒐 𝒅𝒆 𝒅𝒊𝒗𝒐𝒓𝒄𝒊𝒐, 𝒔𝒆𝒓á 𝒏𝒆𝒄𝒆𝒔𝒔á𝒓𝒊𝒐 𝒐 𝒑𝒂𝒈𝒂𝒎𝒆𝒏𝒕𝒐 𝒅𝒆 𝒖𝒎𝒂 𝒕𝒂𝒙𝒂 𝒅𝒆 415 җ ʙʏᴛᴇᴄᴏɪɴꜱ.
𝑫𝒆𝒔𝒆𝒋𝒂 𝒄𝒐𝒏𝒕𝒊𝒏𝒖𝒂𝒓 ?
...
╰─...⎔⎓──────────`)
 ...
 else if(global.db.data.chats[m.chat].users[m.sender].artifacts>=1 || isOwner){
  global.db.data.chats[m.chat].users[m.sender].artifacts-=1
  if(global.db.data.chats[m.chat].users[vitimaVictor].mortoDemonio){
 return m.reply(`
 𖤝⎓──────────────
 ✞ 𝐕𝐨𝐜𝐞̂ 𝐧𝐚̃𝐨 𝐜𝐨𝐧𝐬𝐞𝐠𝐮𝐢𝐫𝐚 𝐫𝐞𝐯𝐢𝐯𝐞𝐫 𝐞𝐬𝐭𝐚 𝐚𝐥𝐦𝐚
 
𝐄𝐥𝐚 𝐟𝐨𝐢 𝐣𝐨𝐠𝐚𝐝𝐚 𝐚𝐬 𝐜𝐡𝐚𝐦𝐚𝐬 𝐝𝐨 𝐢𝐧𝐟𝐞𝐫𝐧𝐨 𝐞 𝐬𝐨́ 𝐯𝐨𝐥𝐭𝐚𝐫𝐚́ 𝐚𝐩𝐨́𝐬 𝐜𝐮𝐦𝐩𝐫𝐢𝐫 𝐬𝐮𝐚 𝐩𝐞𝐧𝐢𝐭𝐞̂𝐧𝐜𝐢𝐚
 𖤝⎓──────────────`)
  }
...
┗━── `)
 ...
 const mensagemStalk = [
  `@${m.sender.split('@')[0]} 𝒆𝒔𝒄𝒐𝒏𝒅𝒆𝒖-𝒔𝒆 𝒔𝒐𝒓𝒓𝒂𝒕𝒆𝒊𝒓𝒂𝒎𝒆𝒏𝒕𝒆 𝒆 𝒄𝒐𝒏𝒕𝒊𝒏𝒖𝒐𝒖 𝒂 𝒗𝒊𝒈𝒊𝒂 𝒅𝒆 @${vitimaStalk.split('@')[0]}, 𝒔𝒕𝒂𝒍𝒌𝒆𝒂𝒏𝒅𝒐 𝒔𝒖𝒂 𝒑𝒆𝒔𝒔𝒐𝒂."
  `,
...
┗━── `, // Replace with the desired caption
    ...
    m.reply(`⎔⎓──────────────
┃  ✞︎  𝑨𝒐 𝒐𝒃𝒔𝒆𝒓𝒗𝒂𝒓 𝒔𝒆𝒖 𝒂𝒍𝒗𝒐... 𝒈𝒂𝒏𝒉𝒐𝒖 𝒖𝒎𝒂 𝑨𝒅𝒂𝒈𝒂
𝒅𝒂𝒔 𝑺𝒐𝒎𝒃𝒓𝒂𝒔 🗡
╰─...⎔⎓──────────`);
...
┗━── `, // Replace with the desired caption
    ...
    m.reply(`⎔⎓──────────────
┃ 𖢣 𝑽𝒐𝒄𝒆 𝒄𝒐𝒏𝒔𝒆𝒈𝒖𝒊𝒖 𝒔𝒂𝒏𝒈𝒖𝒆 𝒐 𝒔𝒖𝒇𝒊𝒄𝒊𝒆𝒏𝒕𝒆 𝒑𝒂𝒓𝒂 𝒕𝒐𝒓𝒏𝒂𝒓-𝒔𝒆 𝒊𝒏𝒗𝒖𝒍𝒏𝒆𝒓𝒂𝒗𝒆𝒍

𖣐 𝚅𝚘𝚌𝚎 𝚜𝚎 𝚝𝚘𝚛𝚗𝚘𝚞 𝚒𝚖𝚘𝚛𝚝𝚊𝚕 𝚙𝚘𝚛 𝟺 𝚑𝚘𝚛𝚊𝚜
╰─...⎔⎓──────────`);
global.db.data.chats[m.chat].users[m.sender].vampireAtivo= true
 setTimeout(() => global.db.data.chats[m.chat].users[m.sender].vampireAtivo=
 false, 4 * 60 * 60 * 1000);
...
if (typeof global.db.data.chats[m.chat].users[who].shields === 'undefined') {
  global.db.data.chats[m.chat].users[who].shields = 0;
}
if(global.db.data.chats[m.chat].users[who].shieldAtivo &&  !isOwner) {
let punicao = Math.floor(Math.random() * (300 - 100 + 1)) + 100
 m.reply(`⎔⎓──────────────
┃ 🌙 𝑬𝒔𝒕𝒂 𝒂𝒍𝒎𝒂 𝒆𝒔𝒕𝒂 𝒑𝒓𝒐𝒕𝒆𝒈𝒊𝒅𝒂 𝒑𝒆𝒍𝒂 𝒍𝒖𝒛 𝒅𝒐 𝒍𝒖𝒂𝒓 𝒅𝒂𝒔 𝒔𝒐𝒎𝒃𝒓𝒂𝒔 𝒇𝒖𝒓𝒕𝒊𝒗𝒂𝒔 𝒒𝒖𝒆 𝒆𝒔𝒑𝒓𝒆𝒊𝒕𝒂𝒎 𝒂 𝒏𝒐𝒊𝒕𝒆. 
╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
𖥠 𝑨 𝒑𝒖𝒏𝒊𝒄𝒂𝒐 𝒅𝒐𝒔 𝑫𝒆𝒖𝒔𝒆𝒔 𝒓𝒆𝒄𝒂𝒊 𝒔𝒐𝒃𝒓𝒆 𝒕𝒊 𝒆
𝒑𝒆𝒓𝒅𝒆𝒔 ${punicao} җ 𝙳𝚊𝚛𝚔𝚌𝚘𝚒𝚗𝚜
╰─...⎔⎓──────────`)
...
if (global.db.data.chats[m.chat].language === 'pt') {
    rouboPrin = `
>>> [!] 🌙 𝑬𝒔𝒔𝒂 𝒑𝒓𝒊𝒏𝒄𝒆𝒔𝒂 𝒆 𝒑𝒓𝒐𝒕𝒆𝒈𝒊𝒅𝒂 𝒑𝒆𝒍𝒂 𝒍𝒖𝒛 𝒅𝒆 𝒎𝒊𝒏𝒉𝒂 𝒔𝒐𝒃𝒆𝒓𝒂𝒏𝒊𝒂 𝒆 𝒊𝒏𝒕𝒂𝒏𝒈𝒊𝒗𝒆𝒍 𝒂 𝒕𝒐𝒅𝒐𝒔 𝒗𝒐𝒄𝒆𝒔, 𝒆 𝒏𝒂𝒅𝒂 𝒊𝒓𝒂 𝒂 𝒂𝒕𝒊𝒏𝒈𝒊𝒓
────────────────────────────────
> [+] Ｖｏｃê　ｐｅｒｄｅｒá　${𝚙𝚞𝚗𝚒𝚌𝚊𝚘} ｂｙｔｅｃｏｉｎｓ
────────────────────────────────
    `;
}
else if (global.db.data.chats[m.chat].language === 'en') {
  rouboPrin = `
>>> [!] 🌙 𝑻𝒉𝒊𝒔 𝒑𝒓𝒊𝒏𝒄𝒆𝒔𝒔 𝒊𝒔 𝒑𝒓𝒐𝒕𝒆𝒄𝒕𝒆𝒅 𝒃𝒚 𝒕𝒉𝒆 𝒍𝒊𝒈𝒉𝒕 𝒐𝒇 𝒎𝒚 𝒔𝒐𝒗𝒆𝒓𝒆𝒊𝒈𝒏𝒕𝒚 𝒂𝒏𝒅 𝒊𝒏𝒕𝒂𝒏𝒈𝒊𝒃𝒍𝒆 𝒕𝒐 𝒂𝒍𝒍 𝒐𝒇 𝒚𝒐𝒖, 𝒂𝒏𝒅 𝒏𝒐𝒕𝒉𝒊𝒏𝒈 𝒘𝒊𝒍𝒍 𝒓𝒆𝒂𝒄𝒉 𝒉𝒆𝒓
────────────────────────────────
> [+] Ｙｏｕ　ｗｉｌｌ　ｌｏｓｅ ${𝚙𝚞𝚗𝚒𝚌𝚊𝚘} ｂｙｔｅｃｏｉｎｓ
────────────────────────────────
  `;
}
  m.reply(rouboPrin)
...
if(global.db.data.chats[m.chat].users[who].demonioAtivo &&  !isOwner) {
let punicao = Math.floor(Math.random() * (300 - 100 + 1)) + 100
 m.reply(`𖣐⎓──────────────
...
if(text.length>1 && global.db.data.chats[m.chat].users[m.sender].shadowAtivo &&  !isOwner) {

         
               global.db.data.chats[m.chat].users[m.sender].tentativasRoubo -=
               1;
          ...
          let roubo = parseInt(Math.round(rouf));
            ...
            global.db.data.chats[m.chat].users[m.sender].money += roubo
              ...
              if(!global.db.data.chats[m.chat].users[m.sender].steals) global.db.data.chats[m.chat].users[m.sender].steals = 0 
           
              global.db.data.chats[m.chat].users[m.sender].steals++
            let mssg = `*╭─┅──┅❖*

𒁂 ${user(m.sender)} ᴜsᴀɴᴅᴏ sᴜᴀs ʜᴀʙɪʟɪᴅᴀᴅᴇs ᴀᴅǫᴜɪʀɪᴅᴀs ᴄᴏᴍᴏ ᴜᴍ ᴇsᴘᴇᴄᴛʀᴏ ᴅᴀ ɴᴏɪᴛᴇ,
ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} җ ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${user(who)}
...
𝒔𝒖𝒃𝒕𝒓𝒂𝒊𝒖 ${roubo} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒅𝒐 𝒅𝒐𝒎í𝒏𝒊𝒐 𝒅𝒆 ${user(who)}.
...
${pickRandom(
            [`𝑸𝒖𝒆 𝒕𝒆𝒖 𝒊𝒏𝒇𝒐𝒓𝒕ú𝒏𝒊𝒐 𝒔𝒊𝒓𝒗𝒂 𝒅𝒆 𝒂𝒅𝒗𝒆𝒓𝒕ê𝒏𝒄𝒊𝒂: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒔𝒆 𝒅𝒆𝒔𝒗𝒂𝒏𝒆𝒄𝒆𝒓𝒂𝒎 𝒆𝒎 𝒕𝒆𝒖 𝒇𝒓𝒂𝒄𝒂𝒔𝒔𝒐. 𝑬𝒔𝒄𝒐𝒍𝒉𝒆 𝒄𝒐𝒎 𝒄𝒂𝒖𝒕𝒆𝒍𝒂, 𝒑𝒐𝒊𝒔 𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂 𝒑𝒐𝒅𝒆 𝒍𝒆𝒗𝒂𝒓 à 𝒑𝒆𝒓𝒅𝒂.`,
            
  `𝑨𝒕𝒆𝒏çã𝒐: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒇𝒐𝒓𝒂𝒎 𝒑𝒆𝒓𝒅𝒊𝒅𝒂𝒔 𝒆𝒎 𝒕𝒆𝒖 𝒇𝒓𝒂𝒄𝒂𝒔𝒔𝒐. 𝑸𝒖𝒆 𝒆𝒔𝒕𝒂 𝒑𝒆𝒓𝒅𝒂 𝒕𝒆 𝒆𝒏𝒔𝒊𝒏𝒆 𝒂 𝒔𝒆𝒓 𝒑𝒓𝒖𝒅𝒆𝒏𝒕𝒆 𝒆𝒎 𝒕𝒖𝒂𝒔 𝒆𝒔𝒄𝒐𝒍𝒉𝒂𝒔.`,
  `𝑬𝒊𝒔 𝒂 𝒂𝒅𝒗𝒆𝒓𝒕ê𝒏𝒄𝒊𝒂 𝒔𝒐𝒎𝒃𝒓𝒊𝒂: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒇𝒐𝒓𝒂𝒎 𝒕𝒓𝒂𝒈𝒂𝒅𝒂𝒔 𝒑𝒆𝒍𝒂 𝒗𝒐𝒓𝒂𝒈𝒆𝒎 𝒅𝒆 𝒕𝒆𝒖 𝒇𝒓𝒂𝒄𝒂𝒔𝒔𝒐. 𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒊𝒏𝒇𝒐𝒓𝒕ú𝒏𝒊𝒐 𝒕𝒆 𝒈𝒖𝒊𝒆 𝒑𝒆𝒍𝒂𝒔 𝒔𝒐𝒎𝒃𝒓𝒂𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂, 𝒍𝒆𝒎𝒃𝒓𝒂𝒏𝒅𝒐-𝒕𝒆 𝒔𝒆𝒎𝒑𝒓𝒆 𝒅𝒂 𝒇𝒓𝒂𝒈𝒊𝒍𝒊𝒅𝒂𝒅𝒆 𝒅𝒂𝒔 𝒆𝒔𝒄𝒐𝒍𝒉𝒂𝒔.`,
  `𝑨𝒕𝒆𝒏çã𝒐, 𝒂𝒍𝒎𝒂 𝒅𝒆𝒔𝒗𝒆𝒏𝒕𝒖𝒓𝒂𝒅𝒂: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒔𝒖𝒄𝒖𝒎𝒃𝒊𝒓𝒂𝒎 à 𝒕𝒖𝒂 𝒒𝒖𝒆𝒅𝒂. 𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒅𝒆𝒔𝒂𝒔𝒕𝒓𝒆 𝒕𝒆 𝒔𝒊𝒓𝒗𝒂 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒔𝒐𝒎𝒃𝒓𝒂 𝒑𝒆𝒓𝒑é𝒕𝒖𝒂, 𝒍𝒆𝒎𝒃𝒓𝒂𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒄𝒐𝒏𝒔𝒆𝒒𝒖ê𝒏𝒄𝒊𝒂𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂 𝒆𝒎 𝒕𝒆𝒖𝒔 𝒑𝒂𝒔𝒔𝒐𝒔.`,
  `𝑨𝒍𝒆𝒓𝒕𝒂: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒔𝒆 𝒅𝒊𝒔𝒔𝒊𝒑𝒂𝒓𝒂𝒓𝒂 𝒆𝒎 𝒕𝒆𝒖 𝒇𝒓𝒂𝒄𝒂𝒔𝒔𝒐. 𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒍𝒂𝒎𝒆𝒏𝒕𝒐 𝒕𝒆 𝒆𝒏𝒔𝒊𝒏𝒆 𝒂 𝒕𝒓𝒊𝒍𝒉𝒂𝒓 𝒄𝒐𝒎 𝒄𝒂𝒖𝒕𝒆𝒍𝒂 𝒐𝒔 𝒄𝒂𝒎𝒊𝒏𝒉𝒐𝒔 𝒆𝒔𝒄𝒖𝒓𝒐𝒔 𝒅𝒂 𝒇𝒐𝒓𝒕𝒖𝒏𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒔𝒆𝒋𝒂 𝒕𝒖𝒂 𝒄𝒓𝒖𝒛: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒇𝒐𝒓𝒂𝒎 𝒅𝒆𝒗𝒐𝒓𝒂𝒅𝒂𝒔 𝒑𝒆𝒍𝒐 𝒂𝒃𝒊𝒔𝒎𝒐 𝒅𝒆 𝒕𝒆𝒖 𝒆𝒓𝒓𝒐. 𝑸𝒖𝒆 𝒔𝒆𝒖 𝒆𝒄𝒐 𝒔𝒆𝒋𝒂 𝒕𝒆𝒖 𝒈𝒖𝒊𝒂, 𝒍𝒆𝒎𝒃𝒓𝒂𝒏𝒅𝒐-𝒕𝒆 𝒄𝒐𝒏𝒔𝒕𝒂𝒏𝒕𝒆𝒎𝒆𝒏𝒕𝒆 𝒅𝒂 𝒅𝒐𝒓 𝒄𝒂𝒖𝒔𝒂𝒅𝒂 𝒑𝒆𝒍𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒂 𝒑𝒆𝒓𝒅𝒂 𝒔𝒆𝒋𝒂 𝒕𝒖𝒂 𝒑𝒆𝒏𝒊𝒕ê𝒏𝒄𝒊𝒂: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒔𝒆 𝒅𝒆𝒔𝒗𝒂𝒏𝒆𝒄𝒆𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒑𝒐𝒓 𝒕𝒖𝒂 𝒇𝒂𝒍𝒉𝒂. 𝑸𝒖𝒆 𝒔𝒆𝒖 𝒆𝒄𝒐 𝒍ú𝒈𝒖𝒃𝒓𝒆 𝒕𝒆 𝒂𝒄𝒐𝒎𝒑𝒂𝒏𝒉𝒆, 𝒓𝒆𝒄𝒐𝒓𝒅𝒂𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒔𝒐𝒎𝒃𝒓𝒂𝒔 𝒒𝒖𝒆 𝒑𝒂𝒊𝒓𝒂𝒎 𝒔𝒐𝒃𝒓𝒆 𝒐𝒔 𝒒𝒖𝒆 𝒐𝒖𝒔𝒂𝒎 𝒅𝒆𝒔𝒂𝒇𝒊𝒂𝒓 𝒂 𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒂𝒎𝒂𝒓𝒈𝒂 𝒑𝒆𝒏𝒂𝒍𝒊𝒅𝒂𝒅𝒆 𝒕𝒆 𝒂𝒔𝒔𝒐𝒎𝒃𝒓𝒆: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒔𝒆 𝒅𝒊𝒔𝒔𝒊𝒑𝒂𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎 𝒄𝒂𝒔𝒕𝒊𝒈𝒐 𝒑𝒐𝒓 𝒕𝒖𝒂 𝒅𝒆𝒓𝒓𝒐𝒕𝒂. 𝑸𝒖𝒆 𝒔𝒆𝒖 𝒆𝒄𝒐 𝒔𝒐𝒎𝒃𝒓𝒊𝒐 𝒕𝒆 𝒑𝒆𝒓𝒔𝒊𝒈𝒂, 𝒓𝒆𝒍𝒆𝒎𝒃𝒓𝒂𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒄𝒐𝒏𝒔𝒆𝒒𝒖ê𝒏𝒄𝒊𝒂𝒔 𝒕𝒆𝒓𝒓í𝒗𝒆𝒊𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒂𝒎𝒂𝒓𝒈𝒂 𝒑𝒆𝒓𝒏𝒂𝒍𝒊𝒅𝒂𝒅𝒆 𝒕𝒆 𝒇𝒍𝒂𝒈𝒆𝒍𝒐 𝒕𝒆 𝒄𝒐𝒏𝒔𝒖𝒎𝒂: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒅𝒆𝒔𝒂𝒑𝒂𝒓𝒆𝒄𝒆𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒔𝒆𝒏𝒕𝒆𝒏ç𝒂 𝒑𝒐𝒓 𝒕𝒖𝒂 𝒒𝒖𝒆𝒅𝒂. 𝑸𝒖𝒆 𝒔𝒖𝒂 𝒔𝒐𝒎𝒃𝒓𝒂 𝒕𝒆 𝒂𝒕𝒐𝒓𝒎𝒆𝒏𝒕𝒆, 𝒂𝒅𝒗𝒆𝒓𝒕𝒊𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒄𝒐𝒏𝒔𝒆𝒒𝒖ê𝒏𝒄𝒊𝒂𝒔 𝒕𝒆𝒓𝒓í𝒗𝒆𝒊𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒇𝒍𝒂𝒈𝒆𝒍𝒐 𝒕𝒆 𝒂𝒎𝒑𝒂𝒏𝒉𝒆𝒊𝒓: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒅𝒆 𝒔𝒆𝒓 𝒗í𝒕𝒊𝒎𝒂𝒔 𝒄𝒖𝒆 𝒔𝒆 𝒃𝒂𝒔𝒆𝒊𝒂𝒎 𝒏𝒂 𝒑𝒂𝒔𝒔𝒂𝒈𝒆𝒎, 𝒄𝒐𝒎𝒐 𝒑𝒐𝒅𝒆 𝒍𝒆𝒈𝒂𝒍.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒇𝒍𝒂𝒈𝒆𝒍𝒐 𝒕𝒆 𝒄𝒐𝒏𝒔𝒖𝒎𝒂: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒅𝒆𝒔𝒂𝒑𝒂𝒓𝒆𝒄𝒆𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒔𝒆𝒏𝒕𝒆𝒏ç𝒂 𝒑𝒐𝒓 𝒕𝒖𝒂 𝒒𝒖𝒆𝒅𝒂. 𝑸𝒖𝒆 𝒔𝒆𝒖 𝒔𝒐𝒎𝒃𝒓𝒂 𝒕𝒆 𝒂𝒕𝒐𝒓𝒎𝒆𝒏𝒕𝒆, 𝒂𝒅𝒗𝒆𝒓𝒕𝒊𝒏𝒅𝒐-𝒕𝒆 𝒅𝒂𝒔 𝒄𝒐𝒏𝒔𝒆𝒒𝒖ê𝒏𝒄𝒊𝒂𝒔 𝒕𝒆𝒓𝒓í𝒗𝒆𝒊𝒔 𝒅𝒂 𝒊𝒎𝒑𝒓𝒖𝒅ê𝒏𝒄𝒊𝒂.`,
  `𝑸𝒖𝒆 𝒆𝒔𝒕𝒆 𝒇𝒍𝒂𝒈𝒆𝒍𝒐 𝒕𝒆 𝒂𝒎𝒂𝒓𝒈𝒂 𝒑𝒆𝒓𝒅𝒂 𝒔𝒆𝒋𝒂 𝒕𝒖𝒂 𝒑𝒆𝒏𝒊𝒕ê𝒏𝒄𝒊𝒂: ${perda} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒅𝒆𝒔𝒗𝒂𝒏𝒆𝒄𝒆𝒓𝒂𝒎, 𝒄𝒐𝒎𝒐 𝒖𝒎𝒂 𝒔𝒆𝒏𝒕𝒆𝒏ç𝒂` ])}
...
let edns = valor ? valor : Math.floor(Math.random() * (money/3))
        ...
        global.db.data.chats[m.chat].users[who].money -= dinheiro
            ...
            let mssm = `*╭─┅──┅❖*
━━━⬣ ${uss(who)}
${pickRandom([`\n𖤍  𝑶 𝑬𝒔𝒕𝒂𝒅𝒐 𝒊𝒏𝒔𝒕𝒂𝒖𝒓𝒐𝒖 𝒊𝒎𝒑𝒐𝒔𝒕𝒐𝒔 𝒔𝒐𝒃𝒓𝒆 𝒕𝒊. 𝑷𝒆𝒓𝒅𝒆𝒓𝒂𝒔 ${dinheiro} җ ʙʏᴛᴇᴄᴏɪɴꜱ. 
...
`\n𖤍  𝑶 𝑮𝒓𝒂𝒏𝒅𝒆 𝑰𝒓𝒎𝒂𝒐 𝒑𝒓𝒐𝒄𝒍𝒂𝒎𝒂 𝒂 𝒄𝒐𝒍𝒆𝒕𝒂 𝒅𝒆 𝒊𝒎𝒑𝒐𝒔𝒕𝒐𝒔 𝒅𝒐 𝑬𝒔𝒕𝒂𝒅𝒐: 
 ${dinheiro} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒔𝒆𝒓𝒂𝒐 𝒄𝒐𝒏𝒇𝒊𝒔𝒄𝒂𝒅𝒐𝒔.
...
╰─...⎔⎓──────────`)
 ...
 return !0
  ...
  if(global.db.data.chats[m.chat].users[m.sender].tentativasRoubo>0 ) {    
        global.db.data.chats[m.chat].users[m.sender].rouboTimestamp = new Date();
     ...
     if(global.criador.includes(who))
    {
      ...
      m.reply(`${pickRandom([
        ...
        `𝑪𝒐𝒎𝒐 𝒐𝒖𝒔𝒂 𝒓𝒐𝒖𝒃𝒂𝒓 𝒎𝒆𝒖 𝒄𝒓𝒊𝒂𝒅𝒐𝒓? 𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒄𝒐𝒎𝒐 𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒒𝒖𝒆 𝒐 𝒂𝒈𝒖𝒂𝒓𝒅𝒂 𝒆 𝒕ã𝒐 𝒔𝒐𝒎𝒃𝒓𝒊𝒂 𝒒𝒖𝒂𝒏𝒕𝒐 𝒐𝒔 𝒂𝒃𝒊𝒔𝒎𝒐𝒔 𝒎𝒂𝒊𝒔 𝒑𝒓𝒐𝒇𝒖𝒏𝒅𝒐𝒔, 𝒆 𝒐 𝒑𝒆𝒔𝒐 𝒅𝒐 𝒔𝒆𝒖 𝒂𝒓𝒓𝒆𝒑𝒆𝒏𝒅𝒊𝒎𝒆𝒏𝒕𝒐 𝒔𝒆𝒓𝒂 𝒄𝒐𝒎𝒐 𝒄𝒐𝒓𝒓𝒆𝒏𝒕𝒆𝒔 𝒈𝒆𝒍𝒊𝒅𝒂𝒔 𝒂𝒓𝒓𝒂𝒔𝒕𝒂𝒏𝒅𝒐-𝒐 𝒑𝒂𝒓𝒂 𝒂 𝒆𝒕𝒆𝒓𝒏𝒂 𝒑𝒆𝒏𝒖𝒎𝒃𝒓𝒂.`,
...
𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} җ ʙʏᴛᴇᴄᴏɪɴꜱ`
        ...
        if(global.cocriador.includes(who))
    {
      ...
      m.reply(`${pickRandom([
        ...
        `𝑪𝒐𝒎𝒐 𝒐𝒖𝒔𝒂 𝒓𝒐𝒖𝒃𝒂𝒓 𝒎𝒊𝒏𝒉𝒂 𝒄𝒓𝒊𝒂𝒅𝒐𝒓𝒂? 𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒄𝒐𝒎𝒐 𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒒𝒖𝒆 𝒐 𝒂𝒈𝒖𝒂𝒓𝒅𝒂 𝒆 𝒕ã𝒐 𝒔𝒐𝒎𝒃𝒓𝒊𝒂 𝒒𝒖𝒂𝒏𝒕𝒐 𝒐𝒔 𝒂𝒃𝒊𝒔𝒎𝒐𝒔 𝒎𝒂𝒊𝒔 𝒑𝒓𝒐𝒇𝒖𝒏𝒅𝒐𝒔, 𝒆 𝒐 𝒑𝒆𝒔𝒐 𝒅𝒐 𝒔𝒆𝒖 𝒂𝒓𝒓𝒆𝒑𝒆𝒏𝒅𝒊𝒎𝒆𝒏𝒕𝒐 𝒔𝒆𝒓𝒂 𝒄𝒐𝒎𝒐 𝒄𝒐𝒓𝒓𝒆𝒏𝒕𝒆𝒔 𝒈𝒆𝒍𝒊𝒅𝒂𝒔 𝒂𝒓𝒓𝒂𝒔𝒕𝒂𝒏𝒅𝒐-𝒐 𝒑𝒂𝒓𝒂 𝒂 𝒆𝒕𝒆𝒓𝒏𝒂 𝒑𝒆𝒏𝒖𝒎𝒃𝒓𝒂.`,
...
𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} җ ʙʏᴛᴇᴄᴏɪɴꜱ`
    ...
    if(who == conn.user.jid)
    {
      ...
      m.reply(`${pickRandom([
        ...
        `𝑪𝒐𝒎𝒐 𝒐𝒖𝒔𝒂 𝒎𝒆 𝒓𝒐𝒖𝒃𝒂𝒓? 𝑷𝒆𝒓𝒅𝒆𝒔 ${dinheiro} җ ʙʏᴛᴇᴄᴏɪɴꜱ 𝒄𝒐𝒎𝒐 𝒂 𝒑𝒖𝒏𝒊çã𝒐 𝒒𝒖𝒆 𝒐 𝒂𝒈𝒖𝒂𝒓𝒅𝒂 𝒆 𝒕ã𝒐 𝒔𝒐𝒎𝒃𝒓𝒊𝒂 𝒒𝒖𝒂𝒏𝒕𝒐 𝒐𝒔 𝒂𝒃𝒊𝒔𝒎𝒐𝒔 𝒎𝒂𝒊𝒔 𝒑𝒓𝒐𝒇𝒖𝒏𝒅𝒐𝒔, 𝒆 𝒐 𝒑𝒆𝒔𝒐 𝒅𝒐 𝒔𝒆𝒖 𝒂𝒓𝒓𝒆𝒑𝒆𝒏𝒅𝒊𝒎𝒆𝒏𝒕𝒐 𝒔𝒆𝒓𝒂 𝒄𝒐𝒎𝒐 𝒄𝒐𝒓𝒓𝒆𝒏𝒕𝒆𝒔 𝒈𝒆𝒍𝒊𝒅𝒂𝒔 𝒂𝒓𝒓𝒂𝒔𝒕𝒂𝒏𝒅𝒐-𝒐 𝒑𝒂𝒓𝒂 𝒂 𝒆𝒕𝒆𝒓𝒏𝒂 𝒑𝒆𝒏𝒖𝒎𝒃𝒓𝒂.`,
...
╰─..𖠨..⎔──────────`)
 ...
 return !0
    ...
    if(global.db.data.chats[m.chat].users[who].money <=0){
            m.reply(`─┅──┅❖ 💵 ❖─┅──┅
𝑶 𝒖𝒔𝒖𝒂𝒓𝒊𝒐 𝒆𝒔𝒕𝒂 𝒅𝒆𝒔𝒕𝒊𝒕𝒖𝒊𝒅𝒐 𝒅𝒆 җ ʙʏᴛᴇᴄᴏɪɴꜱ. 𝑶 𝒇𝒖𝒓𝒕𝒐 𝒆 𝒖𝒎𝒂 𝒎𝒊𝒓𝒂𝒈𝒆𝒎 𝒊𝒎𝒑𝒐𝒔𝒔𝒊𝒗𝒆𝒍 𝒏𝒆𝒔𝒕𝒂 𝒆𝒔𝒄𝒖𝒓𝒊𝒅𝒂𝒐.
─┅──┅❖ ❖─┅──┅`)
              return !0
            }
    if(text.length>1 && global.db.data.chats[m.chat].users[m.sender].shadowAtivo &&  !isOwner) {
...
𒁂 ${userH(m.sender)} ᴜsᴀɴᴅᴏ sᴜᴀs ʜᴀʙɪʟɪᴅᴀᴅᴇs ᴀᴅǫᴜɪʀɪᴅᴀs ᴄᴏᴍᴏ ᴜᴍ ᴇsᴘᴇᴄᴛʀᴏ ᴅᴀ
ɴᴏɪᴛᴇ, ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} җ ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${userH(who)}
𒁂
...
𒁂 ${user(m.sender)} ᴜsᴀɴᴅᴏ sᴜᴀs ʜᴀʙɪʟɪᴅᴀᴅᴇs ᴀᴅǫᴜɪʀɪᴅᴀs ᴄᴏᴍᴏ ᴜᴍ ᴇsᴘᴇᴄᴛʀᴏ ᴅᴀ ɴᴏɪᴛᴇ,
ʀᴏᴜʙᴏᴜ ᴄᴏᴍᴏ ᴜᴍ ғᴀɴᴛᴀsᴍᴀ ${roubo} җ ʙʏᴛᴇᴄᴏɪɴꜱ ᴅᴇ ${user(who)} 𒁂
...
if(global.db.data.chats[m.chat].users[m.sender].shadowAtivo && !isOwner) {
...
if(global.db.data.chats[m.chat].users[who].shieldsAtivo &&  !isOwner) {
let punicao = Math.floor(Math.random() * (300 - 100 + 1)) + 100
 m.reply(`⎔⎓──────────────
┃ 🌙 𝑬𝒔𝒕𝒂 𝒂𝒍𝒎𝒂 𝒆𝒔𝒕𝒂 𝒑𝒓𝒐𝒕𝒆𝒈𝒊𝒅𝒂 𝒑𝒆𝒍𝒂 𝒍𝒖𝒛 𝒅𝒐 𝒍𝒖𝒂𝒓 𝒅𝒂𝒔 𝒔𝒐𝒎𝒃𝒓𝒂𝒔 𝒇𝒖𝒓𝒕𝒊𝒗𝒂𝒔 𝒒𝒖𝒆 𝒆𝒔𝒑𝒓𝒆𝒊𝒕𝒂𝒎 𝒂 𝒏𝒐𝒊𝒕𝒆. 
╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
case "pix":
  ...
  {
   console.log(args[0])
    console.log('tst  :'+ /^\d+([,.]\d+)?$/.test(args[0]))
...
{
  m.reply("Saldo insuficiente de җ ʙʏᴛᴇᴄᴏɪɴꜱ. . . ")
  return !0
}
...
m.reply(`🕯️💀 Doando ${args[0]} җ ʙʏᴛᴇᴄᴏɪɴꜱ `)
...
// global.db.data.chats[m.chat].users[who].level
m.reply(`🕯️💀 Doando ${args[1]} җ ʙʏᴛᴇᴄᴏɪɴꜱ `)
return !0
}
else {
...
handler.tags = ["acoes"]
handler.level = 7
handler.command = ['roubar','casar','pix','stalkear','divorciar','tinder', 'reviver','cacar','morder']
