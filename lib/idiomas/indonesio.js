...
const smsLista1 = () => { return `🌟 INFORMASI ByteSec 🌟`}
...
const smsLista7 = () => { return `🐈 PASANG ByteSec 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return ' ByteSec-MD - WhatsApp '}
...
const smsCont7 = () => { return `${global.langTOGGLE['smsAvisoAG']()}*TIDAK MEMILIKI BERLIAN!! 💎 ANDA DAPAT PERGI KE TOKO DENGAN PERINTAH*`}
const smsCont8 = () => { return ` *BERLIAN 💎 DIGUNAKAN*`}
const smsCont9 = () => { return `${global.langTOGGLE['smsAvisoAG']()}*BUTUH TINGKATNYA ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.langTOGGLE['smsAvisoEG']()}*SEBAGAI ANDA ADMIN DI GRUP INI ANDA TIDAK AKAN DIHAPUS*`}
const smsEnlaceWat = () => { return `${langTOGGLE['smsAvisoAG']()}*LINK WHATSAPP TERBANNED TERDETEKSI DI GRUP INI*\n\n*SAYA LANJUTKAN UNTUK MENGHAPUS ANDA*`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${langTOGGLE['smsAvisoAG']()}LINK TERLARANG MENGANDUNG HTTPS TERDETEKSI DI GRUP INI\n\nSAYA LANJUTKAN UNTUK MENGHAPUS ANDA`}
...
//Kesalahan
const smsMalError = () => { return `${langTOGGLE['smsAvisoFG']()}\`\`\`SEBUAH KESALAHAN YANG TIDAK TERDUGA TELAH TERJADI.\`\`\``}
const smsMalError2 = () => { return `${langTOGGLE['smsAvisoFG']()}\`\`\`KENYAMANAN TELAH TIMBUL. COBA LAGI.\`\`\``}
const smsMalError3 = () => { return `${langTOGGLE['smsAvisoFG']()}\`\`\`ADA YANG SALAH, LAPORAN PERINTAH INI MENGGUNAKAN:\`\`\`\n`}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan ByteSec`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan ByteSec di Grup`}
...
//_autosticker.js
const smsAutoStik = () => { return `${langTOGGLE['smsAvisoFG']()}*VIDEO TIDAK HARUS BERAKHIR LEBIH DARI 7 DETIK.*`} 
...
//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${langTOGGLE['smsAvisoMG']()}*TULIS ALASAN KENAPA TIDAK AKTIF (AFK)*\n\n*CONTOH:*\n*${usedPrefix + command}* Saya akan mengerjakan pekerjaan rumah`} 
const smsAfkQ2 = () => { return `${langTOGGLE['smsAvisoMG']()}*MINIMUM 10 KARAKTER HARUS MENJADI ALASAN*`} 
const smsAfkM1A = () => { return `*JANGAN TAG*`} 
const smsAfkM1B = () => { return `*AKAN AFK TIDAK AKTIF*\n\n*ALASAN TIDAK AKTIFNYA AFK:*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${langTOGGLE['smsAvisoFG']()}*ANDA TIDAK DALAM CHAT ANONIM*`} 
...
const smsChatAn4 = () => { return `${langTOGGLE['smsAvisoRG']()}🪐 *ANDA MENINGGALKAN CHAT ANONIM*`} 
const smsChatAn5 = () => { return `${langTOGGLE['smsAvisoAG']()}*PENGGUNA LAIN MENINGGALKAN CHAT ANONIM*`}  
const smsChatAn6 = () => { return `*JIKA INGIN KE CHAT ANONIM LAIN GUNAKAN PERINTAH #start ATAU GUNAKAN TOMBOL DI BAWAH INI*\n`} 
const smsChatAn7 = () => { return `${langTOGGLE['smsAvisoAG']()}*ANDA MASIH DALAM CHAT ANONIM ATAU MENUNGGU SESEORANG UNTUK BERGABUNG KE CHAT*`} 
...
const smsChatAn10 = () => { return `${langTOGGLE['smsAvisoEG']()}✨ *MEREKA BISA CHAT SEKARANG*`} 
const smsChatAn11 = () => { return `*SESEORANG BERGABUNG DENGAN CHAT ANONIM!!*`} 
const smsChatAn12 = () => { return `❇️ PENGGUNA LAIN`} 
const smsChatAn13 = () => { return `${langTOGGLE['smsAvisoRG']()}🐈 *MENUNGGU SESEORANG UNTUK BERGABUNG DENGAN CHAT ANONIM, HARAP SABAR*`} 
...
const smsMalused2 = () => { return `${langTOGGLE['smsAvisoMG']()}🐈 *ANDA HARUS MENGGUNAKAN PERINTAH SEPERTI CONTOH INI:*\n`}
const smsMalused3 = () => { return `${langTOGGLE['smsAvisoMG']()}🐈 *ANDA HARUS MENGGUNAKAN PERINTAH ATAU MERESPON PESAN SESEORANG SEPERTI CONTOH INI:*\n`}
...
//grupo-add.js
const smsAddB1 = () => { return `${langTOGGLE['smsAvisoFG']()}*TIDAK BISA MENAMBAH NOMOR, HARAP VERIFIKASI BENAR, MUNGKIN BARU KELUAR ATAU PRIVASI ANDA SUDAH DITETAPKAN.*`}
const smsAddB2 = () => { return `${langTOGGLE['smsAvisoFG']()}*TIDAK DAPAT MENAMBAHKAN NOMOR, MEMVERIFIKASI BENAR, ATAU MENAMBAHKANNYA SECARA MANUAL.*`}
...
const smsAdveu1 = () => { return `${langTOGGLE['smsAvisoAG']()}*HANYA DAPAT DIGUNAKAN JIKA FUNGSI DIAKTIFKAN:*\n`}
const smsAdveu2 = () => { return 'Alasan'}
const smsAdveu3 = () => { return `${langTOGGLE['smsAvisoMG']()}*INGAT UNTUK MENULIS ALASAN UNTUK PERINGATAN*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${langTOGGLE['smsAvisoAG']()}*TAG ORANG ATAU BALAS PESAN ORANG YANG INGIN ANDA HAPUS*\n\n*CONTOH: `}
...
//grupo-setbye.js
const smsSetB = () => { return `${langTOGGLE['smsAvisoEG']()}*PERPISAHAN GRUP TELAH DIKONFIGURASI*`}
const smsSetB2 = () => { return `${langTOGGLE['smsAvisoIIG']()}🙌 *_TULIS PESAN PERPISAHAN_*\n*_OPSIONAL, ANDA DAPAT MENGGUNAKAN APA DENGAN "@" UNTUK MENAMBAHKAN INFORMASI LEBIH LANJUT:_*\n\n*⚡ @user (Sebutkan kepada pengguna)*\n\n*INGAT BAHWA "@" ITU OPSIONAL*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${langTOGGLE['smsAvisoEG']()}*SAMBUTAN GRUP TELAH DIATUR*`}
const smsSetW2 = () => { return `${langTOGGLE['smsAvisoIIG']()}🙌 *_TULIS PESAN SELAMAT DATANG_*\n*_OPSIONAL, ANDA DAPAT MENGGUNAKAN APA DENGAN "@" UNTUK MENAMBAHKAN INFORMASI LEBIH LANJUT:_*\n\n*⚡ @user (Sebutkan kepada pengguna)*\n*⚡ @subject (Nama grup)*\n*⚡ @desc (Deskripsi grup)*\n\n*INGAT BAHWA "@" ADALAH OPSIONAL*`}

//grupo-setdesc.js
const smsDest = () => { return `${langTOGGLE['smsAvisoEG']()}*DESKRIPSI GRUP TELAH DIKONFIGURASI*`}

//grupo-setname.js
const smsNam1 = () => { return `${langTOGGLE['smsAvisoEG']()}*NAMA GRUP TELAH DITETAPKAN*`}
const smsNam2 = () => { return `${langTOGGLE['smsAvisoMG']()}*🙌 TULIS NAMA GRUP BARU*`}
const smsNam3 = () => { return `${langTOGGLE['smsAvisoFG']()}*NAMA GRUP TIDAK BOLEH MEMILIKI LEBIH DARI 25 KARAKTER*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${langTOGGLE['smsAvisoEG']()}*TAUTAN GROUP TELAH DIRESET*`}
...
//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${langTOGGLE['smsAvisoMG']()}*TAG SESEORANG ATAU BALAS PESAN PENGGUNA ATAU TULIS NOMOR YANG INGIN ANDA BALAS DARI PERINTAH*\n\n*CONTOH:*\n*${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${langTOGGLE['smsAvisoFG']()}*@${bot} TIDAK DAPAT DILARANG DENGAN PERINTAH INI* 😹`}
const smsPropban3 = (ownerNumber) => { return `${langTOGGLE.smsAvisoIIG()}😳 *SAYA TIDAK BISA MELARKAN PEMILIK @${ownerNumber} DARI ${packname}*`}
const smsPropban4 = (number) => { return `${langTOGGLE.smsAvisoIIG()}*TIDAK PERLU BAN LAGI @${number} YA SUDAH ADA* 😊`}
const smsPropban5 = () => { return `${langTOGGLE['smsAvisoEG']()}*PENGGUNA BERHASIL DILARANG* 🙀`}
const smsPropban6 = (number, usr) => { return `${langTOGGLE.smsAvisoAG()}*@${number} ANDA DILARANG OLEH @${usr} ANDA TIDAK DAPAT MENGGUNAKAN PERINTAH HINGGA SESEORANG MEMBALIKKAN BAN* 😿`}
const smsPropban7 = (usedPrefix, command, number) => { return `${langTOGGLE['smsAvisoFG']()}*KESALAHAN MUNCUL, MUNGKIN PENGGUNA TIDAK DALAM DATABASE SAYA MENCOBA MENULIS ${usedPrefix + command} ${number}*\n\`\`\`JIKA KESALAHAN TERUS LANGSUNG LAPORKAN PERINTAH INI\`\`\``}
...
const smsJBConexionClose2 = () => { return `${langTOGGLE['smsAvisoFG']()}🔴 *PERANGKAT ANDA TELAH TERHUBUNG*\n\n*ANDA HARUS TERHUBUNG LAGI UNTUK MENGGUNAKAN:\n#deletesesion`}
const smsreenvia = () => { return `*🟢 KIRIM ULANG PERINTAH...*`}
const smsSoloOwnerJB = () => { return `${langTOGGLE['smsAvisoAG']()}*PERINTAH INI DINONAKTIFKAN OLEH PEMILIK SAYA*`}
const smsJBPrincipal = () => { return `${langTOGGLE['smsAvisoAG']()}🔵 *UNTUK JADI SUB BOT MASUK KE NOMOR UTAMA*\n*ღ Masukkan tautan berikut:*\n`}
const smsJBConexion = () => { return `${langTOGGLE['smsAvisoFG']()}🟡 *KONEKSI TELAH DITUTUP DENGAN CARA YANG TIDAK TERDUGA, KAMI AKAN MENCOBA MENGHUBUNGKAN KEMBALI...*`}
const smsJBConexionClose = () => { return `${langTOGGLE['smsAvisoFG']()}🔴 *KONEKSI TELAH DITUTUP, ANDA HARUS MENGHUBUNGKAN SECARA MANUAL MENGGUNAKAN #jadibot PERINTAH DAN PINDAI ULANG KODE QR BARU*`}
const smsJBConexionTrue = () => { return `${langTOGGLE['smsAvisoEG']()}🟢 *KONEKSI SUKSES!!!*`}
const smsJBConexionTrue2 = () => { return `${langTOGGLE['smsAvisoEG']()}🟢 *KONEKSI SUKSES!!! ANDA DAPAT MENGHUBUNGKAN MENGGUNAKAN:*`}
const smsJBCargando = () => { return `${langTOGGLE['smsAvisoIIG']()}⚪ *TERHUBUNG!! SILAKAN TUNGGU PESAN sedang DIMUAT...*\n\n♻️ *PILIHAN YANG TERSEDIA:*\n*» #stop _(Hentikan Fitur Sub Bot)_*\n*» #deletesesion _(Hapus semua jejak Sub Bot)_*\n*» #jadibot _(Dapatkan kode QR baru untuk menjadi Sub Bot)_*`}
const smsJBInfo1 = () => { return `💖 *LINK BERMANFAAT*`}
const smsJBInfo2 = () => { return `💖 *Fungsinya stabil, jika menimbulkan ketidaknyamanan Hubungi surat: centerByteSec@gmail.com*\n💝 *Anda dapat memberikan sumbangan sukarela melalui PayPal: ${global.paypal}*\n\n*Terima kasih banyak atas dukungan ${global.packname}*`}

//jadibot-deleteSesion.js
const smsJBDel = () => { return `${langTOGGLE['smsAvisoAG']()}*GUNAKAN PERINTAH INI KE BOT UTAMA*`}
const smsJBAdios = () => { return `${langTOGGLE['smsAvisoEG']()}*AKU AKAN MERINDUKANMU ${global.packname} SELAMAT TINGGAL!! 🥹*`}
const smsJBCerrarS = () => { return `${langTOGGLE['smsAvisoEG']()}*ANDA TELAH KELUAR DAN MENGHAPUS SEMUA JEJAK*`}
const smsJBErr = () => { return `*ANDA TELAH LOG OUT SEBAGAI SUB BOT* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${langTOGGLE['smsAvisoAG']()}*PERINTAH 🔞 MEREKA CACAT, JIKA ANDA ADALAH CREATOR SAYA GUNAKAN #on modohorny*`}
...
const smsContacto4 = () => { return 'Kontak Resmi ByteSec 🐈'}
