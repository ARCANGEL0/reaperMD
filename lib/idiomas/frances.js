...
const smsLista1 = () => { return `🌟 INFORMATIONS ByteSec 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALLER ByteSec 🐈`}
...
//afk-_afk.js
const smsAfkM1 = () => { return `${langTOGGLE['smsAvisoEG']()}*DEJASTE DE ESTAR INACTIVO AFK*`} 
const smsAfkM2 = () => { return `*EL MOTIVO DE INACTIVIDAD ERA:*`} 
const smsAfkM3 = () => { return `*TIEMPO INACTIVO:*`} 
const smsAfkM4 = () => { return `${langTOGGLE['smsAvisoAG']()}*NO ETIQUETES A ESTE(A) USUARIO(A)!! ESTÁ INACTIVO(A)*`} 
...
//afk-afk.js
const smsAfkM1A = () => { return `${langTOGGLE['smsAvisoAG']()}*NO ETIQUETEN A*`} 
...
const smsJBConexionTrue2 = () => { return `${langTOGGLE['smsAvisoEG']()}🟢 *CONEXIÓN CON ÉXITO!!! PUEDE CONECTARSE USANDO:*`}
